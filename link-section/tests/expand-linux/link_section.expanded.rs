...
impl FOO {
    ...
    pub const fn const_deref(&self) -> &'static TypedSection<fn()> {
        static SECTION: TypedSection<fn()> = {
                ...
                ::link_section::__support::PtrBounds::new(
                    {
                        ...
                        extern "C" {
                            #[link_name = "__start__data_link_section_FOO0oQeuvPbYet"]
                            static __SYMBOL: u8;
                        }
                    ...
                    },
                    {
                        #[allow(missing_unsafe_on_extern)]
                        extern "C" {
                            #[link_name = "__stop__data_link_section_FOO0oQeuvPbYet"]
                            static __SYMBOL: u8;
                        }
                        unsafe { &raw const __SYMBOL as *const () }
                    },
            ...
            let name = "_data_link_section_FOO0oQeuvPbYet";
...
fn foo() {
    const _: fn() = const {
        ...
        #[used]
        #[link_section = "_data_link_section_FOO0oQeuvPbYet"]
