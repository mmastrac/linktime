...
- Added UEFI support (`*-unknown-uefi`), via `run_constructors`/`run_destructors`.
- The crate is now `#![no_std]` when the `std` feature is disabled.

## [0.19.0] - 2026-08-09

- Bumped `ctor`, `dtor`, `link-section` and `linktime-proc-macro` dependencies.
